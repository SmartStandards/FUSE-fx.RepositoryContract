...
//  public class EntitySchemaBasedEfRepository<TEntity> : EfRepositoryBase, IRepository<TEntity>, ILinqRepository<TEntity> where TEntity : class, new() {
//    private readonly SchemaRoot _SchemaRoot;

//    public EntitySchemaBasedEfRepository(DbContext context, SchemaRoot schemaRoot) : base(context) {
