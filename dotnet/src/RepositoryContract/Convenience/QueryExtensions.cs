...
//      //  int numberOfArguments = expression.MatchValues.Count + expression.Expressions.Count;
//      //  if (numberOfArguments != 1) { return ""; }
//      //  if (expression.MatchValues.Count == 1) {
//      //    return CompileRelationToWhereStatement(expression.MatchValues[0], mode, prefix);
//      //  } else {
//      //    return CompileToWhereStatement(expression.Expressions[0], mode, prefix);
//      //  }
//      //}

//      //List<string> childResults = new List<string>();
//      //foreach (RelationElement relationElement in expression.MatchValues) {
//      //  childResults.Add(CompileRelationToWhereStatement(relationElement, mode, prefix));
//      //}
//      //foreach (ExpressionTree ex in expression.Expressions) {
...
//      object relationElement, string mode, string prefix
//    ) {
