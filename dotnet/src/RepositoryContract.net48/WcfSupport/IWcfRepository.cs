...
namespace System.Data.Fuse.WcfSupport {
  ...
  [ServiceContract]
  public interface IWcfRepository<TEntity, TKey> where TEntity : class {
    ...
    [WebInvoke(Method = "POST")] int Count(ExpressionTree filter);
    ...
    /// <param name="searchExpression"></param>
    /// <returns></returns>
    [WebInvoke(Method = "POST")] int CountBySearchExpression(string searchExpression);

    [WebInvoke(Method = "POST")] bool ContainsKey(TKey key);
    ...
    [WebInvoke(Method = "POST")] Dictionary<string, object> AddOrUpdateEntityFields(Dictionary<string, object> fields);
    ...
    /// (2) was updated using normlized (=modified) value that differs from the given one,
    /// (3) was updated implicitely (timestamp's,rowversion's,...) 
    [WebInvoke(Method = "POST")] TEntity AddOrUpdateEntity(TEntity entity);
    ...
    /// (2) was updated using normlized (=modified) value that differs from the given one,
    /// (3) was updated implicitely (timestamp's,rowversion's,...) 
    [WebInvoke(Method = "POST")] Dictionary<string, object> TryUpdateEntityFields(Dictionary<string, object> fields);
    ...
    /// (3) was updated implicitely (timestamp's,rowversion's,...) 
    /// </returns>
    [WebInvoke(Method = "POST")] TEntity TryUpdateEntity(TEntity entity);
    ...
    [WebInvoke(Method = "POST")] TKey TryAddEntity(TEntity entity);
    ...
    [WebInvoke(Method = "POST")] TKey[] MassupdateByKeys(TKey[] keysToUpdate, Dictionary<string, object> fields);
    ...
    /// </param>
    /// <returns></returns>
    [WebInvoke(Method = "POST")] TKey[] Massupdate(ExpressionTree filter, Dictionary<string, object> fields);
    ...
    /// </param>
    /// <returns></returns>
    [WebInvoke(Method = "POST")] TKey[] MassupdateBySearchExpression(string searchExpression, Dictionary<string, object> fields);
    ...
    [WebInvoke(Method = "POST")] TKey[] TryDeleteEntities(TKey[] keysToDelete);
    ...
    /// <returns></returns>
    [WebInvoke(Method = "POST")] bool TryUpdateKey(TKey currentKey, TKey newKey);
