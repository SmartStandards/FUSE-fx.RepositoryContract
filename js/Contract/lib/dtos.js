 ...
 */
var GetEntitySchemaResponse = /** @class */ (function () {
    function GetEntitySchemaResponse() {
    }
    return GetEntitySchemaResponse;
}());
exports.GetEntitySchemaResponse = GetEntitySchemaResponse;
